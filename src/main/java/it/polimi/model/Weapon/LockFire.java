...
public class LockFire extends WeaponCard {
    ...
    public void effect2(GameModel gameModel, Player target2){
        ...
        if(gameModel.getActualPlayer().getPlayerBoard().getAmmoR()==1 || gameModel.getActualPlayer().getPlayerBoard().getPlayerPowerUps().get(0).getColorPowerUpCard()==EnumColorCard.RED){
