...
public enum WeaponsEffect implements Serializable {
    ...
    ExtraGrenadeEffect,RocketJumpEffect,FragmentingWarheadEffect,PiercingMode,ShadowstepEffect,SliceAndDiceEffect,
    ScannerMode,LongBarrelMode,RocketFistMode,TsunamiMode,PulverizeMode,MoveTarget,BaseEffectPlusChargedShotEffect,
    BaseEffectPlusFragmentingWarheadEffect;
}
