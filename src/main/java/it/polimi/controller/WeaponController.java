...
public class WeaponController {
    ...
    public void WeaponController(FunctionController functionController){
    
        this.beforeEffect = functionController.beforeEffect;
        this.functionController = functionController;
        this.powerUpSelected = functionController.powerUpSelected;
        this.weaponName = functionController.weaponName;
        this.weaponSelected = functionController.weaponSelected;
    ...
    public void selectWeapon(FunctionModel functionModel, RemoteView view) throws RemoteException {
        ...
        if(functionModel.getGameModel().getActualPlayer().getPlayerBoard().getPlayerWeapons().get(i)!=null){
            ...
            if(weapon.isCharge()){
                ...
                switch (name) {
                    case "CYBERBLADE":
                        ...
                        //set the effect list
                        functionController.weaponController.setListEffect(functionModel,weapon);
                        break;
                    case "ELECTOSCYTHE":
                ...
                //weapon not charge
                functionController.setErrorState(functionModel,"THIS WEAPON IS NOT CHARGE: YOU CAN'T USE IT NOW");
            }
            ...
            functionController.mapErrorGestor(functionModel);
        }
    ...
    public void selectWeaponEffect(FunctionModel functionModel, RemoteView view) throws RemoteException {
        ...
        if (gameModel.getAvailableEffect().get(i)!=null) {
            ...
            functionController.setErrorState(functionModel,"NOT VALID INPUT");
        }
        ...
        try {
            switch (functionModel.getGameModel().getWeaponState()){
                ...
                case LockRifle:
                    ...
                    LockRifle lockRifle = (LockRifle) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                ...
                case Electroscythe:
                    ...
                    Electroscythe electroscythe = (Electroscythe) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                ...
                case MachineGun:
                    ...
                    MachineGun machineGun = (MachineGun) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseEffect :
                ...
                case TractorBeam:
                    ...
                    TractorBeam tractorBeam = (TractorBeam) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseMode :
                ...
                case Thor:
                    ...
                    Thor thor =(Thor) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseEffect :
                ...
                case VortexCannon:
                    ...
                    VortexCannon vortexCannon = (VortexCannon) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseEffect :
                ...
                case Furnace:
                    ...
                    Furnace furnace = (Furnace) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseMode :
                ...
                case PlasmaGun:
                    ...
                    PlasmaGun plasmaGun = (PlasmaGun) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseEffect :
                ...
                case Heatseeker:
                    ...
                    Heatseeker heatseeker = (Heatseeker) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                ...
                case Whisper:
                    ...
                    Whisper whisper = (Whisper) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                ...
                case Hellion:
                    ...
                    Hellion hellion = (Hellion) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseMode :
                ...
                case Flamethrower:
                    ...
                    Flamethrower flamethrower = (Flamethrower) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseMode :
                ...
                case Zx2:
                    ...
                    Zx2 zx2 = (Zx2) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseMode :
                ...
                case GrenadeLauncher:
                    ...
                    GrenadeLauncher grenadeLauncher = (GrenadeLauncher) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseEffect :
                ...
                case Shotgun:
                    ...
                    Shotgun shotgun = (Shotgun) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseMode :
                ...
                case RocketLauncher:
                    ...
                    RocketLauncher rocketLauncher = (RocketLauncher) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseEffect :
                ...
                case PowerGlove:
                    ...
                    PowerGlove powerGlove = (PowerGlove) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseMode :
                ...
                case Railgun:
                    ...
                    Railgun railGun = (Railgun) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseMode :
                ...
                case Shockwave:
                    ...
                    Shockwave shockwave = (Shockwave) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseMode :
                ...
                case Cyberblade:
                    ...
                    Cyberblade cyberblade = (Cyberblade) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseEffect :
                ...
                case Sledgehammer:
                    ...
                    Sledgehammer sledgehammer = (Sledgehammer) functionController.weaponController.getCorrectWeapon(functionModel,this.weaponName);
                    switch(functionModel.getGameModel().getWeaponsEffect()){
                        //I effect
                        case BaseMode :
        ...
        switch (gameModel.getWeaponsEffect()) {
            ...
            case BaseEffect:
                ...
                try {
                    ...
                    if (target2Base == null) {
                        ...
                        functionController.playerDamage=1;
                        ...
                        functionController.playerDamage=2;
                ...
                if(beforeEffect== WeaponsEffect.BaseEffect) {
                    ...
                    try {
                        ...
                        if (targetFocusShot == target1Base) {
                            ...
                            functionController.playerDameged = target1Base;
                            
                            if(targetFocusShot == target2Base) {
                                
                                weapon.focusShotEffect(currentPlayer, targetFocusShot);
                                
                                functionController.playerDameged = target2Base;
            ...
            case TurretTripodEffect:
                ...
                if(beforeEffect == WeaponsEffect.BaseEffect) {
                    ...
                    if (functionController.playerDamage == 1) {
                        if(choice1) {
                    ...
                    } else if (functionController.playerDamage == 2) {
